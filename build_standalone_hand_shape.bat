...
copy config_files\config_array_zw_after.json dist\interface_hand_shape\_internal\config_array.json
mkdir dist\interface_hand_shape\_internal\ordinary
...
mkdir dist\interface_hand_shape\ordinary\resources
copy ordinary\resources\logo.png dist\interface_hand_shape\ordinary\resources\logo.png
pause