...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layout.addLayout(self.horizontalLayout, 0, 0, 1, 1)
        ...
        self.layout.addWidget(self.fig_image, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_fixed.setText(_translate("Form", "手掌电子皮肤显示程序V1.2  途见科技（北京）有限公司"))
