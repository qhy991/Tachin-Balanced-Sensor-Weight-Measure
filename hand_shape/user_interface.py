...
import traceback
import numpy as np
from ordinary.data_handler import DataHandler
...
class HandPlotManager(pyqtgraph.ImageView):
...
class Window(QtWidgets.QWidget, Ui_Form):
    ...
    def __init__(self):
        ...
        #
        self.data_handler = DataHandler(TactileDriverWithPreprocessing, max_len=2)
        self.is_running = False
        #
        self.hand_plot_manager = HandPlotManager(fig_widget=self.fig_image,
