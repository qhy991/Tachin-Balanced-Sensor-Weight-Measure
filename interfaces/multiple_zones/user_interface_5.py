...
class Window(QtWidgets.QWidget, Ui_Form):
    ...
    def __init__(self, mode, fixed_range=False):
        ...
        self.plots = {
            ...
            3: self.create_an_image(self.fig_image_3),
            4: self.create_an_image(self.fig_image_4)
        }
        self.labels = {
            0: self.label_image_0,
            1: self.label_image_1,
            2: self.label_image_2,
            3: self.label_image_3,
            4: self.label_image_4
        }
        self.mode = mode
        ...
        config_mapping = get_config_mapping('zc')
        for key, label in self.labels.items():
            label.setText(config_mapping["names"][str(key)])
