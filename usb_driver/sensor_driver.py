...
import copy
from usb_driver.usb_backend import UsbBackend
...
class UsbSensorDriver(AbstractSensorDriver):
    ...
    def __init__(self, buffer_length, sensor_shape, bytes_per_point):
        ...
        self.sensor_backend = UsbBackend(buffer_length, sensor_shape, bytes_per_point)  # 后端自带缓存，一定范围内不丢数据
...
class SensorDriver16(UsbSensorDriver):
    ...
    def __init__(self):
        super(SensorDriver16, self).__init__(64, self.SENSOR_SHAPE, 2)
